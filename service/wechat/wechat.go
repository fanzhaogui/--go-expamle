...
const (
	...
	AppID     = "wxab2c94c60e3896d8"
	AppSecret = "ed268bd3f60365445a08a4c9d726c55a"
)
...
// Login 用户登录
// @code 小程序登录时获取的 code
func Login(code string) (lres LoginResponse, err error) {
	if code == "" {
		err = errors.New("code can not be null")
		return
	}

	api, err := code2url(code)
	if err != nil {
		return
	}
...
func code2url(code string) (string, error) {
